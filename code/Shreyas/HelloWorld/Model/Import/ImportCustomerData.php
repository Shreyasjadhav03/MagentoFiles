<?php
namespace Shreyas\HelloWorld\Model\Import;
 ...
 */
class ImportCustomerData extends AbstractEntity
{
    const ENTITY_CODE = 'importData';
    const TABLE = 'import_customer_data';
    const ENTITY_ID_COLUMN = 'customer_id';
...
public function validateRow(array $rowData, $rowNum): bool
{
    ...
    $telephone = $rowData[ 'customer_telephone'] ?? '';
    ...
    if (!$telephone) {
        $this->addRowError('TelephoneIsRequired', $rowNum);
    }
...
private function initMessageTemplates()
{
    ...
    $this->addMessageTemplate(
        'EmailIsRequired',
        __('Email should be greater than 0.')
    );
    $this->addMessageTemplate(
        'TelephoneIsRequired',
        __('Telephone should be greater than 0.')
    );
}
